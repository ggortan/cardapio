...
<head>
    <meta charset="UTF-8">
    <title>Meu Perfil - Cardápio Digital</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="public/cardapio.php">Cardápio Digital</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="public/cardapio.php">Cardápio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="public/meus-pedidos.php">Meus Pedidos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="perfil.php">Meu Perfil</a>
                    </li>
                </ul>
